function handler(event) {
    ...
    var agent = headers['user-agent'].value;
    ...
    if (flag == 2) {
        ...
        console.log('error en user-agent no encontrado al procesar la regla 1');
    }
    // end regla 1
    ...
    if (resultAM != null){   // es Android*Mobile entonces devolvemos 302 y nueva location
        flag = 2;
        console.log('device si es Android Mobile: devolviendo respuesta 302 al usuario');
    }
    else{
    ...
    if (flag == 2) {
        ...
        console.log('error en user-agent no encontrado al procesar la regla 2');
    }
    // end regla 2
